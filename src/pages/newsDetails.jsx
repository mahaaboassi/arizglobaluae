...
const NewsDetails = ()=>{
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 1C8.05228 1 8.5 1.44772 8.5 2V3H15.5V2C15.5 1.44772 15.9477 1 16.5 1C17.0523 1 17.5 1.44772 17.5 2V3.02469C20.0267 3.27555 22 5.40733 22 8V17C22 19.7614 19.7614 22 17 22H7C4.23858 22 2 19.7614 2 17V8C2 5.40733 3.97334 3.27555 6.5 3.02469V2C6.5 1.44772 6.94772 1 7.5 1ZM4.17071 7H19.8293C19.4175 5.83481 18.3062 5 17 5H7C5.69378 5 4.58254 5.83481 4.17071 7ZM20 9H4V17C4 18.6569 5.34315 20 7 20H17C18.6569 20 20 18.6569 20 17V9ZM6 12C6 11.4477 6.44772 11 7 11H17C17.5523 11 18 11.4477 18 12C18 12.5523 17.5523 13 17 13H7C6.44772 13 6 12.5523 6 12Z" fill="white"/>
    </svg>
    const avatar =<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 123 123" fill="none">
    <g clipPath="url(#clip0_300_1072)">
    ...
    return(<div>
        <Banner link={"/news"} firstPath={"News"} secondPath={data.category} />
        <div className="details-news gap-10 px-4 sm:px-10 py-20">
            <div className="details-news-first">
                <img src={data.image} alt={data.title} />
                <div className="flex gap-3 items-center info-details pt-5">
                    <div className="flex gap-1 items-center">{avatar} Ariz</div>
                    <div className="flex gap-1 items-center">{calendar} {data.date}</div>
                </div>
                <h1 className="py-5">{data.title}</h1>
                <div className="artical" dangerouslySetInnerHTML={{__html: data.all_description}} />
            </div>
            <div style={{height:"fit-content"}} className="details-news-second p-5 sm:p-10 shadow">
                <h2 className="">Recent Posts :</h2>
                <div className="end-card "></div>
                {news.map((e,idx)=>{
                    return(<div  key={`Lastest_news_${e.title}_${idx}`}>
                       <Link to={`/news/${e.link}`}>
                        <div className="card-details-news gap-2" >
                                <div className="card-details-news-first"><img  src={e.image} alt={e.title} /></div>
                                <div className="card-details-news-second flex flex-col gap-2 justify-center">
                                    <h3>{e.title}</h3>
                                    <div className="card-details-news-date flex items-center gap-2">
                                        {calendar}{e.date}</div>
                                </div>
                            </div>
                       </Link>
                    {idx != news.length-1 && <div className="end-card "></div>}

...
const News = ()=>{
    ...
    const arrow = <svg xmlns="http://www.w3.org/2000/svg" width="13" height="8" viewBox="0 0 13 8" fill="none">
    ...
    return(<div id="news" className="news relative  px-4 py-16  sm:px-10">
        ...
        <div className="container-news pt-16  " >
            <div className="content-news gap-10"style={{
                        display: 'flex',
                ...
                {
                   news.map((e,idx)=>(<div className="card-news p-0.5 gap-4 " key={`News_${e.title}_${idx}`}>
                    <div className="card-img-news">
                    ...
                    <p className="px-5 pb-8">{e.description}</p>
        ...
        <div className="content-arrows px-2">
                <div onClick={prevSlide} className="last">
                    {arrow}
                </div>
